<article class="artistlist">
	<div id="artistindex" class="row">
		...
		<section class="artistinfo col col-sm-9">
			...
			<?php include 'php/snippet_artist_Lorenzo_Garcia.php'; ?>
			<?php include 'php/snippet_artist_Hillary_Goldwynn.php'; ?>
			<?php include 'php/snippet_artist_Hassum_Harrod.php'; ?>
			<?php include 'php/snippet_artist_Jennifer_Jerome.php'; ?>
			<?php include 'php/snippet_artist_LaVonne_LaRue.php'; ?>
			<?php include 'php/snippet_artist_Riley_Rewington.php'; ?>
			<?php include 'php/snippet_artist_Constance_Smith.php'; ?>
