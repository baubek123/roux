<div class="tab-pane active" id="monday">
	...
	<section class="media">
		<a href="artists.php#LaVonne_LaRue" class="pull-left" data-toggle="tooltip" title="LaVonne LaRue"><img class="img-rounded" src="images/artists/LaVonne_LaRue_tn.jpg" alt="Photo of LaVonne LaRue"></a>
	...
	<section class="media">
		<a href="artists.php#Lorenzo_Garcia" class="pull-left" data-toggle="tooltip" title="Lorenzo Garcia"><img class="pull-left img-rounded" src="images/artists/Lorenzo_Garcia_tn.jpg" alt="Photo of Lorenzo Garcia"></a>
	  	<div class="media-body">
	  		<h4>11:00am-1pm</h4>
	...
	<section class="media">
		<a href="artists.php#Richard_Tweed" class="pull-left" data-toggle="tooltip" title="Richard Tweed"><img class="pull-left img-rounded" src="images/artists/Richard_Tweed_tn.jpg" alt="Photo of Richard Tweed"></a>
	  	<div class="media-body">
	  		<h4>2:30-4:00pm</h4>
			<h3>Still Life</h3>
			<h4>Dennison Hall</h4>
